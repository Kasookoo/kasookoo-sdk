...
public final class ActivityCallHistoryBinding implements ViewBinding {
  ...
  private ActivityCallHistoryBinding(@NonNull LinearLayout rootView,
      @NonNull TextView btnClearHistory, @NonNull RecyclerView recyclerViewHistory,
  ...
  public static ActivityCallHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCallHistoryBinding((LinearLayout) rootView, btnClearHistory,
          recyclerViewHistory, tvEmptyState);
    }
